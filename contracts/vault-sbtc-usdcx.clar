...
;; (.sbtc-usdcx-jing-v3, x=sBTC, y=USDCx) with a Bitflow
...
;;   (.sbtc-usdcx-jing-v3), into Bitflow's
...
(define-public (cancel-jing-usdcx)
  (begin
    ...
    (try! (contract-call? .jing-core log-cancel
      .sbtc-usdcx-jing-v3 USDCX_TOKEN))
    (ok true)))
