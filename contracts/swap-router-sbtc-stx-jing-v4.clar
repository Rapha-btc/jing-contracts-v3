...
;; u3007). Market unchanged: markets-sbtc-stx-jing-v5 (deployed as
;; markets-sbtc-stx-jingswap).
;; v2: the market is markets-sbtc-stx-jing-v5 on Pyth Lazer; `update` is a
...
;; The market: markets-sbtc-stx-jing-v5 at chavita.btc's address, the same
