;; ============================================================================
;; RENDEZVOUS INVARIANTS for markets-sbtc-stx-jing
;; ============================================================================
;; Append-only block. The build script concatenates this onto the production
;; contract source to produce tests/rv/.build/markets-sbtc-stx-jing.clar
...
(define-read-only (invariant-balance-eq-cycle-totals)
  (let (
    ...
    (mock-bal (unwrap-panic (contract-call? .mock-ft get-balance 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.markets-sbtc-stx-jing)))
    (stx-bal (stx-get-balance 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.markets-sbtc-stx-jing))
  )
