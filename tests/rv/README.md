...
The [current receipt properties and validation results](../../contracts/README-jing-ladder-dispatch.md#receipt-verification)
cover the tuple responses for deposit, withdrawal, claim, and batch dispatch.
