...
// changed. Generated from verify-markets-v4-withdraw.js.
// verify-markets-v6-withdraw.js
...
// bound to jing-core-v5 (log-withdraw-x/y). Deploys core-v4 + the market
...
//
// Run: npx tsx simulations/verify-markets-v6-withdraw.js
//      PYTH_API_KEY=<key> npx tsx simulations/verify-markets-v6-withdraw.js
...
const MARKET = "markets-sbtc-stx-jing-v6";
...
async function main() {
  ...
  const depositX = (sender, amount, limit, cid = CID) =>
    call(sender, "deposit-token-x", [uintCV(amount), uintCV(limit), noneCV(), UPDATE, sbtcTrait, sbtcAsset], cid);
  const depositY = (sender, amount, limit, cid = CID) =>
    call(sender, "deposit-token-y", [uintCV(amount), uintCV(limit), noneCV(), UPDATE, wstxTrait, wstxAsset], cid);
