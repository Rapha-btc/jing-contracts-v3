...
|-----|------------|----------|----------------|
| `verify-v6-3-submit-settle-lazer.js` | n/a | [719/719](https://stxer.xyz/simulations/mainnet/37585a22f95c0cc4dbd7261cf9b43ca5) | v6-3 submit/settle: deposits, limits, readmits, maker/taker reprice, pending isolation, moving books, exact batch payouts, queue refunds and parked carry. Entry-only minimum policy: direct/pending submits and swap net checked before escrow; accepted pending orders survive minimum raises; queue refusals preserve incumbents; swap dust remainder refunded. [Coverage, core caller audit, and remaining gaps](verify-v6-3-submit-settle-coverage.md). Actual deploy-copy source from the working tree. |
