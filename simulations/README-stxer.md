...
|-----|------------|----------|----------------|
| `verify-v6-3-submit-settle-lazer.js` | n/a | [598/600 — FAIL](https://stxer.xyz/simulations/mainnet/fed442065c5b484b541f624fe427c816) | v6-3 submit/settle: deposits, limits, readmits, maker/taker reprice, pending isolation, moving books, exact batch payouts, queue refunds including core fallback and parked-carry preservation; submit minimum and changed-minimum refunds. Current core/catch revision fails the regression for an incumbent parked before a minimum refusal. [Coverage and remaining gaps](verify-v6-3-submit-settle-coverage.md). Unmodified deploy-copy source from the working tree. |
