...
|-----|------------|----------|----------------|
| `verify-v6-rungs-escrow-timeout.js` | n/a | [549/549](https://stxer.xyz/simulations/mainnet/e63243934144cace6c9e4d753176cb30) | All six rungs: normal young exits preserved; young paused exits refused; cancellation at age >= 24h works without an update or through market/core pauses. Exact two-member payouts and remaining shares, refund events, nonmember rejection, and empty final balances. [Details and regression run](README-v6-rungs-escrow-timeout.md). |
| `verify-v6-3-submit-settle-lazer.js` | n/a | [950/950](https://stxer.xyz/simulations/mainnet/ec3b1f35d30a51b6106573b591c86703) | v6-3 submit/settle: deposits, limits, readmits, maker/taker reprice, pending isolation, moving books, exact batch payouts, queue refunds and parked carry. Entry-only minimum policy: direct/pending submits and swap net checked before escrow; accepted pending orders survive minimum raises; queue refusals preserve incumbents; swap dust remainder refunded. Limit-check relocation preserves baseline zero-limit rejection with exact rollback; positive-limit full/partial fills match before/after on both sides. Cancel refunds pending + live + parked, clears pending metadata, and works through market/core pauses; combined-balance coverage uses a labelled, fully funded storage fixture. [Coverage, core caller audit, and remaining gaps](verify-v6-3-submit-settle-coverage.md). Actual deploy-copy source from the working tree. |
