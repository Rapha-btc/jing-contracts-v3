...
// changed. Generated from verify-markets-v4-regression.js.
...
// Everything below is the v2 harness otherwise. Run: PYTH_API_KEY=<key> npx tsx simulations/verify-markets-v6-regression.js
...
async function main() {
  ...
  const vaaBuf = DUMMY_VAA; // patched source reads storage; no live VAA needed
  ...
  b = call(SBTC_DEPOSITOR_1, "set-token-x-limit", [uintCV(LIVE_X), noneCV(), vaaBuf])(b); // retarget live -> u1016
